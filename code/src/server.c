...
/**
 * @brief Function to handle the signal
 *
 * @param signum
 */
...
int main(int argc, char *argv[])
{
    ...
    char client_address_str[INET_ADDRSTRLEN], address_server_str[INET_ADDRSTRLEN];
    ...
    inet_ntop(AF_INET, &(client_address.sin_addr), address_server_str, INET_ADDRSTRLEN);
